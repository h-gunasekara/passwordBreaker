...
<meta content="proj-2/sha256.c · master · Junhao Gan / COMP30023-LabCode-Current" property="og:title">
...
<meta content="https://gitlab.eng.unimelb.edu.au/junhaog/comp30023-labcode-current/blob/master/proj-2/sha256.c" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="proj-2/sha256.c · master · Junhao Gan / COMP30023-LabCode-Current" property="twitter:title">
...
<title>proj-2/sha256.c · master · Junhao Gan / COMP30023-LabCode-Current · GitLab</title>
...
<meta name="csrf-token" content="KWPR+u4FS2ItcnpNDBzCHiXLWuJwjuM1G4i96ObgAuODQp2D3mLkiUDW95df/dEsWk3onI/pU5KT5jJGd1oUNg==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/junhaog/comp30023-labcode-current/blob/master/proj-2/sha256.c">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/junhaog/comp30023-labcode-current/commits/9279f3f9769cb15ed37d116e6ef3ec70d522a8cc/signatures"></div>
...
<input type="hidden" name="path" id="path" value="proj-2/sha256.c" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/junhaog/comp30023-labcode-current/blob/master/proj-2/sha256.c"><strong>sha256.c</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/junhaog/comp30023-labcode-current/blame/master/proj-2/sha256.c">Blame</a><a class="btn" href="/junhaog/comp30023-labcode-current/commits/master/proj-2/sha256.c">History</a><a class="btn js-data-file-blob-permalink-url" href="/junhaog/comp30023-labcode-current/blob/9279f3f9769cb15ed37d116e6ef3ec70d522a8cc/proj-2/sha256.c">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-9279f3f9">
...
<a class="commit-row-message item-title" href="/junhaog/comp30023-labcode-current/commit/9279f3f9769cb15ed37d116e6ef3ec70d522a8cc">sha256.c: More sensible name for library</a>
<span class="commit-row-message d-block d-sm-none">
&middot;
9279f3f9
</span>
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="931" href="/llandrew">Lachlan Andrew</a> authored <time class="js-timeago" title="Apr 29, 2019 3:04am" datetime="2019-04-29T03:04:24Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Apr 29, 2019</time>
</div>
</div>
<div class="commit-actions flex-row d-none d-sm-flex">

<div class="js-commit-pipeline-status" data-endpoint="/junhaog/comp30023-labcode-current/commit/9279f3f9769cb15ed37d116e6ef3ec70d522a8cc/pipelines?ref=master"></div>
<div class="commit-sha-group">
<div class="label label-monospace">
9279f3f9
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA to clipboard" data-class="btn btn-default" data-clipboard-text="9279f3f9769cb15ed37d116e6ef3ec70d522a8cc" type="button" title="Copy commit SHA to clipboard" aria-label="Copy commit SHA to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;proj-2/sha256.c&quot;,&quot;gfm&quot;:&quot;`proj-2/sha256.c`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
<small>
5.14 KB
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;555e543b6eedd6df27b6716181c259356117eb2a&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/junhaog/comp30023-labcode-current/raw/master/proj-2/sha256.c"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="proj-2/sha256.c" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/junhaog/comp30023-labcode-current/raw/master/proj-2/sha256.c?inline=false"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#download"></use></svg></a></div>
<div class="btn-group" role="group">
<button name="button" type="submit" class="btn js-edit-blob  js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/junhaog/comp30023-labcode-current/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fjunhaog%2Fcomp30023-labcode-current%2Fedit%2Fmaster%2Fproj-2%2Fsha256.c&amp;namespace_key=1277">Edit</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/junhaog/comp30023-labcode-current/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2F-%2Fide%2Fproject%2Fjunhaog%2Fcomp30023-labcode-current%2Fedit%2Fmaster%2F-%2Fproj-2%2Fsha256.c&amp;namespace_key=1277">Web IDE</button><button name="button" type="submit" class="btn btn-default js-edit-blob-link-fork-toggler" data-action="replace" data-fork-path="/junhaog/comp30023-labcode-current/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fjunhaog%2Fcomp30023-labcode-current%2Fblob%2Fmaster%2Fproj-2%2Fsha256.c&amp;namespace_key=1277">Replace</button><button name="button" type="submit" class="btn btn-remove js-edit-blob-link-fork-toggler" data-action="delete" data-fork-path="/junhaog/comp30023-labcode-current/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fjunhaog%2Fcomp30023-labcode-current%2Fblob%2Fmaster%2Fproj-2%2Fsha256.c&amp;namespace_key=1277">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/junhaog/comp30023-labcode-current/blob/master/proj-2/sha256.c">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/junhaog/comp30023-labcode-current/blob/master/proj-2/sha256.c?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace sha256.c</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/junhaog/comp30023-labcode-current/update/master/proj-2/sha256.c" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="egOquILjUafdMtHjDPSgWH9aD9HJ0fJ0kelgNoVtWk/QIubBsoT+TLCWXDlfFbNqANy9rza2QtMZh++YFNdMmg==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-316598e99df9698e491a490e7d759fd7">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-316598e99df9698e491a490e7d759fd7" class="form-control js-commit-message" placeholder="Replace sha256.c" required="required" rows="3">
Replace sha256.c</textarea>
</div>
</div>
</div>
